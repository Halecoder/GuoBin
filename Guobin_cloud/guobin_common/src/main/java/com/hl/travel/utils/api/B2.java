package com.hl.travel.utils.api;
...
public class B2 implements AutoCloseable{
    ...
    public B2() {
        out = System.out;
        client = B2StorageClientFactory.createDefaultFactory().create(S3Constant.ACCESSKEY,S3Constant.SECRETKEY,S3Constant.USER_AGENT);
    }
    ...
    public static void usageAndExit(String errMsg) {
...
//    }
    ...
    public void cancel_all_unfinished_large_files(String[] args) throws B2Exception {
        // <bucketName>
    ...
    public void cancel_large_file(String[] args) throws B2Exception {
        // <largeFileId>
        checkArgCount(args, 1);
    ...
    public void create_bucket(String[] args) throws B2Exception {
    ...
    public void update_bucket(String[] args) throws B2Exception {
        // <bucketName> <bucketType>
        checkArgCount(args, 2);
        final String bucketName = args[0];
        final String bucketType = args[1];
    ...
    public void update_bucket_cors_rules(String[] args) throws B2Exception, B2JsonException {
    ...
    public void delete_bucket(String[] args) throws B2Exception {
        checkArgCount(args, 1);
        final B2Bucket bucket = getBucketByNameOrDie(args[0]);
        client.deleteBucket(bucket.getBucketId());
    }

    public void delete_file_version(String[] args) throws B2Exception {
        // <fileName> <fileId>
        checkArgCount(args, 2);
    ...
    public void download_file_by_id(String[] args) throws B2Exception {
    ...
    public void get_download_authorization(String[] args) throws B2Exception, B2JsonException {
    ...
    public void get_download_file_by_id_url(String[] args) throws B2Exception {
        // [--noProgress] <fileId>
    ...
    public void download_file_by_name(String[] args) throws B2Exception {
    ...
    public void get_download_file_by_name_url(String[] args) throws B2Exception {
    ...
    public void finish_uploading_large_file(String[] args) throws B2Exception {
    ...
    public void get_file_info(String[] args) throws B2Exception {
        // <fileId>
        checkArgCount(args, 1);
    ...
    public void hide_file(String[] args) throws B2Exception {
        // <bucketName> <fileName>
        checkArgCount(args, 2);
        final String bucketName = args[0];
    ...
    public void list_buckets(String[] args) throws B2Exception {
    ...
    public void list_file_names(String[] args) throws B2Exception {
    ...
    public void list_file_versions(String[] args) throws B2Exception {
    ...
    public void list_unfinished_large_files(String[] args) throws B2Exception {
        // <bucketName>
        checkArgCount(args, 1);
        final String bucketName = args[0];
        final B2Bucket bucket = getBucketByNameOrDie(bucketName);
    ...
    public void list_parts(String[] args) throws B2Exception {
        // <largeFileId>
        checkArgCount(args, 1);
        final String largeFileId = args[0];
    ...
    public B2FileVersion upload_file(String[] args,
        ...
        if (forceLarge || client.getFilePolicy().shouldBeLargeFile(contentLength)) {
            ...
            b2FileVersion = client.uploadSmallFile(request);
        }
    ...
    public B2FileVersion getFileVersion(String[] args) throws B2Exception {
        // <bucketName> <fileName>
        checkArgCount(args, 2);
        final String bucketName = args[0];
        final String b2FileName = args[1];
        return client.getFileInfoByName(bucketName, b2FileName);
    }
